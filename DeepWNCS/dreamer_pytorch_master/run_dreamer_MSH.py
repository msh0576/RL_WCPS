...
# 절대 참조
path = '~/works/RL_WCPS-master/DeepWNCS/Inverted_Pendulum_Simulation/'
import sys
...
from dreamer.agents.atari_dreamer_agent import AtariDreamerAgent, PendulumDreamerAgent
...
def build_and_train(log_dir, game="pong", run_ID=0, cuda_idx=None, eval=False, save_model='last', load_model_path=None):
    ...
    agent_ = PendulumDreamerAgent(train_noise=0.4, eval_noise=0, expl_type="epsilon_greedy",
                              expl_min=0.1, expl_decay=2000 / 0.3, initial_model_state_dict=agent_state_dict,
                              model_kwargs=dict(use_pcont=True))
