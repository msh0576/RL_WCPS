...
from latent_ode_master.lib.likelihood_eval import masked_gaussian_log_density
try:
	import umap
except:
	print("Couldn't import umap")

from latent_ode_master.generate_timeseries import Periodic_1d
from latent_ode_master.person_activity import PersonActivity
